export const ERROR_CODES = {
    ...
    LINK_GOOGLE_INVALID: { code: 7, message: "Link_google should be a boolean" },
    LINK_FACEBOOK_INVALID: { code: 8, message: "Link_facebook should be a boolean" },
    ...
    IS_PRIVATE_INVALID: { code: 19, message: "Is_private should be a boolean" },
