  ...
  return (
    <ScrollView contentContainerStyle={[styles.wrapper, theme === 'dark' && styles.dark]}>
      <View style={styles.card}>
        ...
        <Text style={styles.text}>L'utilisation des Services est interdite dans les juridictions où ils seraient en violation des lois locales ou nationales. En utilisant Supchat, vous déclarez que votre accès et votre utilisation des Services respectent les lois en vigueur dans votre région.</Text>
        ...
        <Text style={styles.text}>• <Text style={styles.bold}>Vérification :</Text> Supchat peut, à sa discrétion, demander une vérification de votre identité pour confirmer la propriété du compte, notamment en cas de suspicion d’activité frauduleuse ou de conflit lié à un compte.</Text>

        <Text style={styles.section}>4. Utilisation acceptable</Text>
        <Text style={styles.text}>Vous acceptez de ne pas utiliser Supchat à des fins illégales ou nuisibles. Vous vous engagez à :</Text>
        <Text style={styles.text}>• <Text style={styles.bold}>Respecter les autres utilisateurs :</Text> Ne pas harceler, menacer, diffamer ou discriminer d'autres utilisateurs en fonction de leur race, origine, sexe, orientation sexuelle, religion ou tout autre facteur protégé par la loi.</Text>
        <Text style={styles.text}>• <Text style={styles.bold}>Préserver l'intégrité de la plateforme :</Text> Ne pas distribuer de spams, logiciels malveillants, virus ou tout contenu qui pourrait compromettre la sécurité de Supchat ou de ses utilisateurs.</Text>
        <Text style={styles.text}>• <Text style={styles.bold}>Respecter les lois :</Text> Ne pas violer les lois ou règlements applicables, y compris ceux relatifs à la propriété intellectuelle, à la protection des données et à la confidentialité.</Text>
        <Text style={styles.text}>• <Text style={styles.bold}>Utilisation équitable :</Text> Ne pas exploiter les Services de manière excessive ou abusive, ce qui pourrait affecter l'expérience des autres utilisateurs.</Text>
        <Text style={styles.text}>• <Text style={styles.bold}>Contenu approprié :</Text> Ne pas publier ou partager de contenu illégal, obscène, incitant à la violence ou portant atteinte aux droits d’autrui.</Text>
        <Text style={styles.text}>En cas de violation des règles ci-dessus, Supchat se réserve le droit de suspendre ou de résilier votre accès aux Services, conformément à la section sur la résiliation.</Text>
