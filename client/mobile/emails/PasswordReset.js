...
<a href="${CLIENT_WEB_URL}reset_password?password_reset_token=${password_reset_token}" style="display: inline-block; padding: 12px 24px; background-color: #007bff; color: #fff; text-decoration: none; font-weight: bold; border-radius: 5px;">
